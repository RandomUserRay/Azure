...
local function Play(ID)
    ...
    do
        ...
        local Sections = {
			...
			Others = {
			    Teleport = Tabs.Others:AddLeftGroupbox("Map Teleport"),
				Scripts = Tabs.Others:AddRightGroupbox("Script")
			}
        }
...
game.Players.LocalPlayer.Character.Humanoid.Jump = true
		...
		do
		    ...
		    --// Script
		    do
			    Sections.Others.Scripts:AddButton("Infinite Yield", function()
